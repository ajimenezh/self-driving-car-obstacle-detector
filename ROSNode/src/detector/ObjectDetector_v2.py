...
class ObjectDetector:
    ...
    def __init__(self):
        ...
        self.P = np.matrix(np.eye(4))*100 # initial uncertainty
        self.R = 0.001
...
#                    nxt_radar_idx += 1
                ...
                if real_time < self.last_realtime:
                    ...
                    xml_out.make(self.ntimes(),  self.object_positions,  "ford02",  "Car")
...
#            if self.debug:
#                self.out.write("RadarData\n")
#                self.out.write(str(arr) + "\n")
...
#            if self.debug:
#                self.out.write(str(lidarMsg) + "\n")
#                self.out.write(str(D) + " " + str(val) + "\n")
#                self.out.flush()
