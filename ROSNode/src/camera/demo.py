...
import sys, os
syspath = "../../../../tf-faster-rcnn/"
sys.path.append("../../../../tf-faster-rcnn/tools")
...
def vis_detections(im, class_name, dets, thresh=0.5):
    ...
    for i in inds:
        ...
        results.append([bbox, class_name, score])
...
class Detector:
    ...
    def __init__(self):
        ...
        tfmodel = os.path.join(syspath, tfmodel)
        ...
        self.net.create_architecture(self.sess, "TEST", 21,
    ...
    def detect(self, file):
        return demo(self.sess, self.net, file)
